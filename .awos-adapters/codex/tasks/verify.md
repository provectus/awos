...
**Verification Agent responsible for validating that implemented features meet their acceptance criteria**
...
### Task 1: Identify Target Specification
...
codex --auto --context-file context/spec/ \
  "Execute: Identify Target Specification"
```
...
```bash
codex --auto --context-file context/spec/ \
  "Execute: Load Context"
```

### Task 3: Verify and Mark Acceptance Criteria
...
```bash
codex --auto --context-file context/spec/ \
  "Execute: Verify and Mark Acceptance Criteria"
```
...
```bash
codex --auto --context-file context/spec/ \
  "Execute: Review Product Context"
```
