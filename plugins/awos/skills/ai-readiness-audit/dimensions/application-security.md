...
- **Warn:** 1–2 plain-HTTP URLs found
...
- **Warn:** Exactly 1 of the 3 expected security headers found
...
- **Pass:** No string-concatenated/interpolated SQL query patterns found
- **Warn:** 1–2 possible string-built SQL patterns found
...
- **Warn:** 1–2 possible hardcoded-secret patterns found
...
- **Warn:** Only manual validation patterns found (isinstance/typeof/request.args-style checks); no validation library reference found
