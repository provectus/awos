...
- [x] **Task 3: Add repo-scanner agent definition for Task tool**
  - [x] Subtask: Create `claude/agents/domain-experts/repo-scanner.md` with agent metadata (name, description, model, color). **[Agent: general-purpose]**
...
- [x] **Task 4: Refactor `/awos:registry` to use repo-scanner**
...
- [ ] **Task 5: Add registry-aware context loading to `/awos:product`**
...
- [ ] **Task 6: Add registry-aware context loading to `/awos:roadmap`**
...
- [ ] **Task 7: Add registry-aware context loading to `/awos:architecture`**
...
- [ ] **Task 8: Add registry-aware context loading to `/awos:spec`**
...
- [ ] **Task 9: Add registry-aware context loading to `/awos:tech`**
...
- [ ] **Task 10: Add registry-aware context loading to `/awos:tasks`**
...
- [ ] **Task 11: Add registry-aware context loading to `/awos:implement`**
...
- [ ] **Task 12: Add cross-repo spec reference support**
...
- [ ] **Task 13: Add dependency impact warnings**
