...
- **XML scope-and-investigate snippets.** `commands/implement.md` contains `<scope_discipline>` (don't over-engineer) and `<investigate_before_answering>` (don't hallucinate) — both are passed through to the delegated subagent prompt.
