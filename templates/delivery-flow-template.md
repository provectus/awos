...
5. [CI on the change request — which pipelines trigger, and the policy: wait + fix failures in a loop | report first results and hand off | no CI (local suite is the gate)]
