...
| Item                                                              | Why it passes                                                                                                                                                                                                                                         |
| ----------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/awos:product`, `/awos:architecture`                             | Intent gathering and durable memory. (Brownfield machinery removed in Phase 2; the Open question resolved by relocating the codebase gather into `/awos:architecture`, which runs it in both modes — creation seeds defaults, update surfaces drift.) |
