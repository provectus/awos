...
- **Your Thought Process for Generating Tasks:**
  ...
  4.  **For each sub-task, assign the appropriate subagent:**
      ...
      - Review the descriptions of subagents available via the Agent tool — these descriptions are Claude's dispatch metadata, no extra introspection step is needed
