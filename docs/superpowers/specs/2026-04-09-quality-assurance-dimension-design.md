...
### QA-06: Coverage reporting configured *(optional)*
...
- **Severity:** low *(no FAIL state — this check is advisory only)*
...
### QA-09: Contract testing *(conditional)*
...
### QA-10: ML model iteration testing *(conditional)*
