...
| #189       | Split (judged 2026-09-10)      | The spec-directory definition unification fixes wrong scores today — merges once carved out (with the missing version bump); the orchestration-root mode is end-of-life surface (principle 1), its kernel carried by re-targeting #172 at the successor audit                      |
