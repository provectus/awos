...
| ------------------------- | -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **awos** (deprecated)     | `/awos:ai-readiness-audit` | Extensible, dimension-based AI-readiness audit. A deterministic engine scores every dimension in one pass; the model fills only a small judgment slice. In maintenance, scheduled for removal once its successor ships. See [awos/README.md](awos/README.md). |
