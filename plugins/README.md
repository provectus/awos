...
| ------------------------- | ---------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **awos**                  | `/awos:ai-readiness-audit`, `/awos:flow` | Comprehensive AI readiness audit across 12 scored dimensions — security, architecture, documentation, AI tooling, and more — plus end-to-end delivery-flow setup tailored to the team.                                                 |
...
| **profiler**              | `/profiler:implement`                    | Profiles `/awos:implement` runs from the session transcripts: where the wall-clock went, per-subagent rates, delegation chains, effort leaks, and a live watch that flags hung commands. See [profiler/README.md](profiler/README.md). |
