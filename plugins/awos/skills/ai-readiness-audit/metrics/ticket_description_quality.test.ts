/**
 * Tests for ticket_description_quality — ticket description quality/richness.
 *
...
test('ticket_description_quality: standards.toml [category.ticket_description_quality].weight === 3', () => {
